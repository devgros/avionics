...
class FactureController extends MyAdminController
{
	...
	protected function showAction()
    {
        ...
        if($facture->getNumFacture() == "F065-25-AVIONICS"){
    ...
    public function addAvoirAction()
    {
        ...
        if(empty($last_avoir)){
            $current_year = date("y");
            $new_num = "FA001-".$current_year."-AVIONICS";
        }else{
            ...
            if($current_year > $last_year){
                ...
                $new_num = 'FA'.str_pad(($last_num+1), 3, "0", STR_PAD_LEFT)."-".$current_year."-AVIONICS";
            }
        }
    ...
    public function showAvoirAction()
    {
        ...
        if($avoir->getNumAvoir() == "FA002-20-AVIONICS"){
